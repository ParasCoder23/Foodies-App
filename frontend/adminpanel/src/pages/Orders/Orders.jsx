...
// Use Vite env for API base URL; fall back to localhost for dev
...
const Orders = () => {
  ...
  const response = await axios.patch(`${API_BASE}/api/orders/status/${orderId}?status=${event.target.value}`)
